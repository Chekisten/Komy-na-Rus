...
if (mysqli_stmt_prepare($stmt, 'SELECT id FROM users WHERE email=?')) {
...
$query = "INSERT INTO `users` (`id`, `email`, `pass`, `verified`, `created_at`, `confirmation_token`) VALUES (NULL, ?, '$pass', 'N', NOW(), '$confirmation_token')";
